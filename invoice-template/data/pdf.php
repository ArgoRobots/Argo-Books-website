...
return [
  ...
  'meta_description' => 'Free PDF invoice templates in five styles. Customize every field, download in one click, no signup. Pick Classic, Modern, Formal, Elegant, or Ribbon.',
  ...
  'body_html' =>
    ...
    . '<p>Five styles cover the most common visual preferences. Classic is a traditional dark header with sans-serif body for general business use. Modern is a teal accent with a clean sans-serif feel. Formal strips the document back to plain typography and lots of whitespace. Elegant is a yellow header bar with high contrast that suits agencies and creative shops. Ribbon uses serif headings with a thin navy rule under the header for law firms, consulting practices, and accountants.</p>',
  ...
  'related_slugs' => ['word', 'excel', 'classic-pdf', 'modern-pdf', 'formal-pdf', 'elegant-pdf', 'ribbon-pdf'],
];
