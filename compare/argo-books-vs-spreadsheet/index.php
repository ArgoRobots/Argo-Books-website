                ...
                <div class="pc-card pc-argo animate-on-scroll">
                    <div class="pc-block">
                        ...
                        <ul class="pc-list">
                            ...
                            <li><span class="pc-ico pc-pro"><?= svg_icon('check', 16) ?></span><span><strong>Works offline</strong> as a native desktop app for Windows, macOS, and Linux, with your data stored locally, exactly like a file on your disk</span></li>
