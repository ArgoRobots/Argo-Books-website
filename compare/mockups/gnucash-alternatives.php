<?php
// compare/mockups/gnucash-alternatives.php
//
// Decorative price chart for the GnuCash comparison, included by
// compare/compare-page.php inside .diff-mockup. Reads $argo_monthly and the
// price variables that compare/data/gnucash-alternatives.php declares; both that
