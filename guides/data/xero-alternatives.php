<?php
// guides/data/xero-alternatives.php
...
HTML,
    ...
    [
      ...
      'html' => <<<'HTML'
<p>Argo Books sits in the low-cost desktop group, so here's a straight account of what it is and who it's for. It's a desktop accounting app for Windows, macOS, and Linux. It works offline, and your data lives locally on your own machine rather than in someone else's cloud. If one of your reasons for leaving Xero is not wanting your financial data online at all, that's the core of what Argo offers.</p>
...
HTML,
  ...
  'faqs' => [
    ...
    [
      ...
      'a' => 'There are free and freemium accounting tools, and if your books are simple they can genuinely cover invoicing, expenses, and basic reports without a subscription. The honest caveats: free tools tend to move features behind paid tiers over time, their depth and availability vary a lot by country, and live bank feeds like Xero\'s are often limited or missing. Argo Books is free to start too, with caps of {argo_free_invoice_limit} invoices and {argo_free_receipt_scan_limit} receipt scans a month on the free tier, and it runs on your desktop with your data stored locally. Whichever free option you look at, compare what you\'d realistically pay once you use it fully, not just the headline price.',
    ],
    [
      'q' => 'How is Argo Books different from Xero?',
      'a' => 'The biggest differences are where your data lives and how much tool you get. Argo Books is a desktop app for Windows, macOS, and Linux that works offline and keeps your books on your own machine, while Xero is a cloud suite. Argo is simpler and cheaper: free to start, with Premium at {argo_premium_monthly} dollars a month or 150 a year in Canadian dollars, and it builds in inventory and cost of goods sold. The limits are real, though. Argo imports bank data from statements or CSV files rather than using live bank feeds, its only live integration is Stripe, its payroll covers Canada only, and there\'s no portal for an accountant to work inside your file the way Xero offers.',
    ],
    [
