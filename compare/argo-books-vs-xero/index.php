...
<head>
    ...
    <!-- Breadcrumb Schema -->
    <script type="application/ld+json"><?= argo_breadcrumb_schema(["Home" => "/", "Argo Books vs Xero" => "/compare/argo-books-vs-xero/"]) ?></script>
    ...
    <script type="application/ld+json">
        {
            ...
            "mainEntity": [
                ...
                },
                {
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Argo Books runs natively on Windows and Linux. Because it's a desktop app, it's fast and responsive, with no browser tabs and no loading spinners. Xero is web-based and also has a mobile app for iOS and Android."
                    }
                }
            ]
        }
...
<body class="compare-page">
    ...
    <section class="faq">
        <div class="container">
            ...
            <?php $faqs[] = ['q_html' => $q, 'a_html' => ob_get_clean()];
            ob_start(); ?>Does Argo Books support bank connections?<?php $q = ob_get_clean();
            ob_start(); ?>
            ...
            <?php $faqs[] = ['q_html' => $q, 'a_html' => ob_get_clean()];
            ob_start(); ?>How does Argo Books pricing compare to Xero?<?php $q = ob_get_clean();
            ob_start(); ?>
