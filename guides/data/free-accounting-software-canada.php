...
<li><strong>Argo Books.</strong> Freemium, with a no-time-limit free tier covering invoicing, basic bookkeeping, and free receipt scanning, and Premium for higher volumes and advanced features. Prices are in CAD and it handles GST/HST. Built as a desktop app for Windows and Linux, so your data lives on your own machine. Premium also runs Canadian payroll, working out CPP, EI and income tax and preparing your T4 slips. The trade-off: a smaller accountant ecosystem than the older players.</li>
