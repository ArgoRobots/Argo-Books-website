...
<p>What to look for: the tool should let you take a deposit or partial payment against an invoice, record more than one payment on the same invoice, and show a clear balance due at every step. If a tool treats every payment as full-or-nothing, it can't do contracting. Argo Books handles this directly, with deposits, security deposits, and partial payments recorded on the invoice, and an invoice status (Draft, Sent, Partial, Paid, Overdue) that reflects exactly how much has landed. For the mechanics of taking that first payment, see <a href="/how-to-take-a-deposit-on-an-invoice/">how to take a deposit on an invoice</a>.</p>
HTML,
    ],
...
<li><strong>Photo receipt capture.</strong> Can you log a materials receipt from your phone at the counter, without typing?</li>
...
<li><strong>Receipts from the site.</strong> Snap a photo of a materials receipt and the AI pulls the vendor, date, amount, and tax. Ten scans a month on the free tier, 500 on Premium. When the card statement arrives, drop the CSV or PDF in and every line comes back categorized, so nothing slips through.</li>
...
HTML,
  ...
  'tool_callout_text' => 'Argo Books runs on your own machine, handles deposits and progress bills, and scans site receipts from your phone. There\'s a free tier to start on.',
  ...
  'faqs' => [
    ...
    [
      ...
      'a' => 'A deposit is money paid against a job before it\'s finished, so the invoice has to show the full job, the amount already paid, and the balance still owed. If you quote $8,000 and take a $2,400 deposit, the final invoice should show $5,600 due, not $8,000. Progress billing is the same thing spread over stages on a bigger job, for example 30% up front, 30% at rough-in, 30% at finish, and 10% held until inspection. Your tool needs to let you record more than one payment against a single invoice and keep the running balance correct. Argo Books supports deposits and partial payments directly, with the invoice status moving from Partial to Paid as the money comes in.',
    ],
    [
