...
?>
        ...
        <div class="docs-content">
            <p>Secure access to your business data with robust password protection and Windows Hello integration.</p>
            ...
            <ol class="steps-list">
                <li>After setting up password protection, a "Enable Windows Hello" button will appear in the Security settings</li>
            ...
            <div class="info-box">
                <strong>Tip:</strong> Windows Hello options will only appear if your device has compatible hardware (e.g., fingerprint reader or facial recognition camera) and Windows Hello is properly configured in Windows Settings.
            </div>
