            ...
            <div class="payment-methods">
                ...
                <div class="payment-grid">
                    ...
                    <button class="payment-btn" id="pay-stripe">
                        <img class="Stripe" src="../../resources/images/Stripe-logo.svg" alt="Stripe" loading="lazy" width="88" height="22">
                        <span>Pay with Stripe</span>
                    </button>
                    <button class="payment-btn" id="pay-square">
                        <img class="Square" src="../../resources/images/Square-logo.svg" alt="Square" loading="lazy" width="88" height="22">
