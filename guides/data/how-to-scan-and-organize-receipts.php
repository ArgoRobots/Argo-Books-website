<?php
// guides/data/how-to-scan-and-organize-receipts.php
...
<p>It's a desktop app, so your receipts and their images stay on your own machine and work offline. The free tier scans {argo_free_receipt_scan_limit} receipts a month, which covers a lot of sole traders on its own. Premium raises that to {argo_receipt_scan_limit} a month and runs ${argo_premium_monthly}/month if you outgrow the free batch. If you just want to test the reading before installing anything, there's a free web receipt scanner on the site: upload a receipt in the browser and watch it pull the fields out. Snap, confirm, done, and the whole system in this guide runs itself.</p>
HTML,
    ],
  ...
  'faqs' => [
    ...
    [
      ...
      'a' => 'Yes. There\'s a free web receipt scanner on this site where you can upload a receipt in your browser and watch it pull out the vendor, date, amount, and tax, no install needed. Argo Books itself also has a free tier that scans {argo_free_receipt_scan_limit} receipts a month inside the desktop app, which covers a lot of sole traders and freelancers on its own. If you regularly go through more than that, Premium raises the limit to {argo_receipt_scan_limit} a month. Either way you can test the scanning for free before deciding whether you need the higher volume.',
    ],
    [
