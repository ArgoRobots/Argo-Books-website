<?php
// guides/data/what-to-include-on-an-invoice.php
...
<ul>
  ...
  <li><strong>Invoice number.</strong> A unique identifier you can refer back to. <a href="/invoice-numbering-best-practices/">Sequential numbers</a> work fine (1001, 1002, 1003) and so do dated patterns like 2026-001. Whatever system you pick, never repeat a number and never skip one without a reason you can explain.</li>
  <li><strong>Issue date.</strong> The date you sent the invoice. This starts the clock on <a href="/net-30-vs-due-on-receipt/">payment terms</a>, so if your terms say due in 30 days and you issue the invoice on June 1st, the due date is July 1st.</li>
...
<p><strong>Late fee statement.</strong> One short sentence stating the <a href="/late-fees-when-and-how-to-charge/">late fee rate</a> (commonly 1.5% or 2% per month) and when it applies. This rarely gets used in practice, but the fact that it's on the invoice tends to keep payments inside the agreed window.</p>
