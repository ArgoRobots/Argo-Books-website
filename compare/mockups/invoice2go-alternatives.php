<?php
// compare/mockups/invoice2go-alternatives.php
//
// Decorative price chart for the Invoice2Go comparison, included by
// compare/compare-page.php inside .diff-mockup. Reads $argo_monthly and the
// price variables that compare/data/invoice2go-alternatives.php declares; both that
