...
HTML,
  ...
  'faqs' => [
    ...
    [
      ...
      'a' => 'It depends on where your customer is, not where you are. If you and the customer are in the same state, the sale is intra-state and you charge CGST plus SGST, usually 9% each, for a total of 18%. If the customer is in a different state, the sale is inter-state and you charge IGST at the combined rate, usually 18%. Set the right combination in the Tax field for each invoice based on the place of supply.',
    ],
    [
