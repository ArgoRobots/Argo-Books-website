...
<p><strong>United Kingdom.</strong> Income tax with a tax-free personal allowance at the bottom, then banded rates above it, plus <strong>National Insurance</strong>. The self-employed pay Class 2 and Class 4 NI, worked out through Self Assessment. VAT is bucket 3 once you pass the registration threshold. Payments on account mean you can end up pre-paying part of next year's bill, so keep the set-aside going even after you file.</p>
<p><strong>Australia.</strong> Income tax with a tax-free threshold, then banded rates. There's no separate self-employment tax the way the US has one, but you're expected to fund your own <strong>superannuation</strong> since no employer is doing it for you, so treat that as a parallel set-aside. GST is bucket 3 once your turnover passes the registration threshold, and the ATO's PAYG instalment system spreads the income-tax bill across the year.</p>
