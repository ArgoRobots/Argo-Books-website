    ...
    <script type="application/ld+json">
        {
            ...
            "mainEntity": [
                ...
                },
                {
                    ...
                    "acceptedAnswer": {
                        "@type": "Answer",
                        "text": "Argo Books runs natively on Windows and Linux. Because it's a desktop app, it's fast and responsive, with no browser tabs and no loading spinners. ZipBooks is web-based and accessible from any browser."
                    }
                }
            ]
        }
            ...
            <div class="diff-split">
                <div class="diff-copy animate-on-scroll">
                    ...
                    <ul class="why-list">
                        ...
                        <li>
                            <span class="why-check"><?= svg_icon('check', 15) ?></span>
                            <span><strong>Yours, and offline.</strong> A native desktop app for Windows and Linux. Your books open instantly and keep working with no internet, and your data stays on your machine. ZipBooks is cloud-only.</span>
                        </li>
                        <li>
                            <span class="why-check"><?= svg_icon('check', 15) ?></span>
                ...
                <div class="diff-visual animate-on-scroll">
                    ...
                    <div class="diff-callout">
                        ...
                        <span class="diff-callout-sub">Argo Books Premium is cheaper than ZipBooks Smarter and does more</span>
                    </div>
                </div>
            </div>
        </div>
