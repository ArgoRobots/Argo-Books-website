<?php
// guides/data/late-fees-when-and-how-to-charge.php
...
<li>In Canada, late fees are governed mostly by contract law and provincial consumer rules. As of January 1, 2025, the federal Criminal Code caps interest at 35% annual percentage rate (lowered from the old 60% effective annual rate). That puts the legal ceiling at roughly 2.5 to 3% per month simple interest, though most businesses charge far less. The federal Interest Act (section 4) also requires the rate to be stated as an annualised percentage, not just a monthly one: put only a monthly rate on the invoice and you can be limited to recovering 5% per year.</li>
...
HTML,
    ...
    [
      ...
      'html' => <<<'HTML'
<p>The simplest rule is the day after the due date. If the invoice says <a href="/net-30-vs-due-on-receipt/">Net 30</a> and the due date is June 29, the late fee starts on June 30. Anything later than that makes the deadline feel flexible, and clients learn quickly which due dates actually matter.</p>
...
<ul>
<li><strong>First-time slip with a good client.</strong> A client who has paid you on time for a year, who runs a real business, and who missed one due date by a few days. Sending a late-fee invoice over $15 will sour a relationship that could be worth hundreds or thousands of dollars per year. Send a polite reminder, accept the late payment when it arrives, and skip the fee.</li>
<li><strong>Clear miscommunication.</strong> The invoice went to the wrong email. The client thought the deposit covered the final balance. The PO number was missing and the invoice sat in the accounts-payable queue waiting for more information. In cases where the late payment is partly attributable to you, or arises from an innocent misunderstanding, imposing the fee feels punitive. Fix the mix-up, accept the payment, move on.</li>
