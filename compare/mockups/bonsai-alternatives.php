<?php
// compare/mockups/bonsai-alternatives.php
//
// Decorative price chart for the Bonsai comparison, included by
// compare/compare-page.php inside .diff-mockup. Reads $argo_monthly and the
// price variables that compare/data/bonsai-alternatives.php declares; both that
