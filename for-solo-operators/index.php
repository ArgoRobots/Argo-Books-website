        ...
        <div class="container">
            ...
            <div class="fp-benefits">
                ...
                <div class="fp-benefit animate-on-scroll">
                    ...
                    <p>Argo Books runs natively on Windows and Linux. No internet needed at the market booth, no monthly subscription climbing every year, no website to load when the venue wifi is gone. The free tier covers most solo operators forever.</p>
                </div>
            </div>
        </div>
    </section>
