...
return [
  ...
  'intro_html' => <<<'HTML'
<p>An invoice is a bill. It also serves as a tax record, a payment instruction, and a piece of paper the client uses to approve the cost internally. If a field is missing, the invoice can sit on someone's desk for two weeks waiting for clarification. If a field is wrong, the tax office can refuse to accept it as proof of a sale.</p>
...
<ul>
  ...
  <li><strong>Issue date.</strong> The date you sent the invoice. This starts the clock on payment terms, so if your terms say Net 30 and you issue the invoice on 1 June, the due date is 1 July.</li>
  <li><strong>Due date.</strong> The exact day payment is expected, written as a date not a phrase. "Due 30 June 2026" is clearer than "Due in 30 days" because there's no room to argue about when the 30 days started.</li>
  ...
  <li><strong>Line items with quantity and rate.</strong> One row per thing you're charging for, with a clear description, the quantity, the unit rate, and the line total. Vague entries like "Services rendered" slow down approval. Specific entries like "Logo design (1 round of revisions) x 1 at $850" get signed off the same day.</li>
...
<p>A quick sanity check before you hit send: read the invoice top to bottom and ask yourself, "Could a stranger pay this without asking me a single question?" If the answer's no, something is missing.</p>
HTML,
    ],
    ...
    [
      ...
      'anchor' => 'products',
      'html' => <<<'HTML'
<p>Service invoices are simpler. You describe the work, list the hours or the fixed fee, and total it up. Product invoices need a few extra fields because physical goods get tracked, stocked, returned, and audited in ways that hours of consulting never do.</p>
...
<p><strong>Description detail.</strong> Service line items can get away with "Project setup and discovery". Product line items need the colour, size, model number, and (for serial-tracked goods) the serial number itself. The more an item costs, the more detail the buyer expects.</p>
<p><strong>Shipping and delivery.</strong> If you charge for shipping, list it as its own line with the shipping method, the delivery address if it differs from the billing address, and the shipping cost. Bundling shipping into the product price gets messy fast, because returns then have to back out the shipping share line by line.</p>
HTML,
    ],
...
<p><strong>Payment instructions block.</strong> Already covered in the required nine, but worth elevating: a clear, boxed-off section showing the bank name, account number, sort code or routing number, and (for international) the SWIFT or BIC code. If you accept cards or other payment options, list them with a one-line note like "Pay by card: [link]". Make it obvious which option is cheapest for them (usually direct transfer), because the more friction, the longer the wait.</p>
<p><strong>Thank-you line.</strong> A single line at the bottom: "Thanks for your business, looking forward to the next project." Costs you nothing, signals you're a professional human being, and slightly increases the odds the client pays on time because there's a tiny social tug at the end.</p>
...
<p><strong>Late fee statement.</strong> One short sentence stating the late fee rate (commonly 1.5 percent per month or 2 percent per month) and when it applies. This rarely gets used in practice, but the fact that it's on the invoice tends to keep payments inside the agreed window.</p>
<p><strong>Currency code.</strong> If you bill internationally, write the three-letter currency code (USD, GBP, EUR, CAD, AUD) next to every total. The dollar sign alone is ambiguous because Canada, Australia, New Zealand, the US, and several other countries all use it. "USD $1,200" leaves no room for confusion when the buyer pays.</p>
HTML,
    ],
