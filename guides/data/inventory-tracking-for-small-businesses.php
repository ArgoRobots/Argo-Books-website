<?php
// guides/data/inventory-tracking-for-small-businesses.php
...
HTML,
    ...
    [
      ...
      'html' => <<<'HTML'
<p>You don't need inventory software to keep good books, and it would be dishonest to pretend otherwise. Many small product businesses run perfectly well on a spreadsheet for years. Here is a straight read on where the spreadsheet works and where it starts to cost you more than it saves.</p>
...
HTML,
  ...
  'faqs' => [
    [
      ...
      'a' => 'COGS is the cost of the stock you actually sold during a period. It\'s the real expense you subtract from your sales to find your true profit on products. The plain way to work it out is to take the value of the stock you started with, add what you bought during the period, then subtract the value of the stock you have left at the end. What is missing is what you sold, and its cost is your COGS. For example, starting with $2,000 of stock, buying $1,500 more, and ending with $1,800 means $1,700 of goods left the business as sales, so COGS is $1,700. It matters because you are taxed on profit, and real profit needs the cost of what sold, not just the cash you spent on stock.',
    ],
    [
