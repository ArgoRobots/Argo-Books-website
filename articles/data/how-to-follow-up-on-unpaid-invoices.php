...
HTML,
  ...
  'sections' => [
    ...
    [
      ...
      'html' => <<<'HTML'
<p>The first rule of following up is to respect the term you wrote on the invoice. If the invoice says Net 15 and you sent it on June 1, the client has until the end of June 16 to pay. Sending a reminder on June 15 makes you look like you can't count, and it gives a slow payer a reason to push back rather than pay. Wait until the morning of June 17 and the conversation is simple: the invoice is overdue, and you're asking about it.</p>
