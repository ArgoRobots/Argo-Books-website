<?php
// guides/data/quickbooks-price-increases.php
...
<p>Part of why QuickBooks can raise the price every year is that your books live on Intuit's servers and you rent access monthly. Local-first software flips that: the program runs on your own computer and your data stays with you. Argo Books is one option in that camp, and since you are reading this on its site, weigh the mention accordingly. It is a desktop app for Windows, macOS, and Linux with a free tier that has no time limit: {argo_free_invoice_limit} invoices a month, basic bookkeeping, and your data on your own machine, with Premium at ${argo_premium_monthly} CAD a month for higher volumes. The honest caveat, the same one the rest of this cluster makes: Argo Books has payroll for Canadian staff only, so if you pay staff elsewhere through QuickBooks you would need a separate payroll service. If your day-to-day is invoicing, expenses, and reports, though, it does that core well without a yearly price rise attached.</p>
HTML,
    ],
  ...
  'faqs' => [
    ...
    [
      ...
      'a' => 'Yes, partly, and you should read it that way. It is on the Argo Books site, and Argo Books is one of the alternatives it mentions. We tried to keep it honest: the price figures come from public sources, the article says plainly that for some businesses QuickBooks is still worth paying the higher price, and it lists negotiating or staying put as real options alongside switching. Argo Books appears once, near the end, with the caveat that its payroll covers Canada only. If the right answer for you is to keep QuickBooks, that is the honest answer, and we would rather say it than talk you into a switch you do not need.',
    ],
  ],
