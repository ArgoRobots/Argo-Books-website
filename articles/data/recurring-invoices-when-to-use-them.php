...
HTML,
  ...
  'sections' => [
    ...
    [
      ...
      'html' => <<<'HTML'
<p>A recurring invoice is a bill that goes out automatically on a schedule, for the same client, for the same amount or close to it. The schedule can be weekly, every two weeks, monthly, quarterly, or annual. The amount is usually fixed, like a monthly retainer or a flat cleaning fee, but it can also vary a little if the work has small extras each cycle.</p>
...
<p><strong>Late-fee policy that doesn't auto-fire on day one.</strong> A late fee that hits the day after the due date will end a long-term relationship over $15. A grace period of 10 days is normal, and you can word it so the fee is your right to charge, not your default behavior: "Invoices unpaid more than 10 days after the due date may be subject to a late fee of 1.5 percent per month on the outstanding balance." That keeps the policy in place without making the first late payment a fight. See <a href="/late-fees-when-and-how-to-charge/">late fees: when and how to charge them</a> for the full version of this clause.</p>
<p>Two more small things that help. Spell out exactly what the recurring price covers, so a request for extra work outside the scope is clearly an extra. And state in plain language that the invoice is for the upcoming period or the just-finished period, so the client isn't confused about what month they're paying for. Retainers are usually billed in advance, cleaning is usually billed in arrears, and writing it on the invoice ends the question.</p>
HTML,
    ],
...
<ul>
<li><strong>Forgetting to update the price when costs rise.</strong> A cleaning company that quoted $180 a month in 2022 is probably losing money on that client in 2026. The recurring schedule keeps the old number running long after the underlying costs have moved. Review every recurring client at least once a year and decide whether the price still works. If it doesn't, send a price-change notice and move it up.</li>
...
<li><strong>Auto-billing a client whose card has expired.</strong> If you have a card on file and the card expires, the next charge fails. Modern processors send the merchant a failed-payment notification, but it's easy to miss in an inbox full of payment receipts. The client thinks they're paid up; you think they're paid up; in fact nothing has come through. Watch for the failed-payment notifications and follow up the same day.</li>
...
<li><strong>Letting the description rot.</strong> "Monthly services" tells the client nothing six months later when they're looking back at their books. "Cleaning, 4 visits, March 2026" tells them exactly what they paid for. Update the period in the description every cycle. It's one extra change, and it saves an awkward "what was this for?" email later.</li>
</ul>
HTML,
    ],
