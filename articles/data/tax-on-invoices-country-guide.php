...
<p>This guide walks through the five markets the free invoice generator on this site supports as a built-in country selection: the United States, Canada, the United Kingdom, Australia, and India. For each one, you get the standard rate, the registration threshold, and the fields the invoice needs to include. None of this is legal or tax advice. Treat it as a quick orientation, then talk to a local accountant before you send the first invoice with tax on it.</p>
HTML,
  ...
  'sections' => [
    ...
    [
      ...
      'html' => <<<'HTML'
<p>This article is a country-by-country orientation, not a tax filing. It covers five markets in detail because those are the five the free invoice generator fully supports as a one-click country selection today: the United States, Canada, the United Kingdom, Australia, and India. For each one, the section below lists the standard rate, the registration threshold, and the main fields the invoice has to include. If your customer is in one of those five countries, the generator will relabel the tax row and the currency for you when you pick the country at the top of the form.</p>
...
<p>One thing this guide isn't: tax advice for your specific situation. Rates change. Thresholds change. Categories get reclassified. A photographer in California has different sales-tax exposure than a software developer in California, and both can change again if the customer is across a state line. The rates and thresholds below were accurate as of writing, but you should check the current rules with a local accountant before you rely on any of them. There's no substitute for someone who knows your books and your jurisdiction.</p>
<p>Treat the rest of this guide as a starting point. Use it to set up a clean invoice that includes the right labels and fields, then double check the rate itself with an accountant in the country you're billing.</p>
HTML,
    ],
    ...
    [
      ...
      'html' => <<<'HTML'
<p>The United States doesn't have a federal sales tax. Instead, 45 of the 50 states run their own sales tax, and many cities and counties stack a local rate on top. That's why a coffee in one town can be taxed at 6 percent and the same coffee twenty miles down the road taxed at 9.25 percent. The rate is set at the state, county, and sometimes city level, all rolled into a single number on the invoice.</p>
<p>Five states have no statewide sales tax at all: Alaska, Delaware, Montana, New Hampshire, and Oregon. Alaska is the most common asterisk in that list, because some Alaskan cities and boroughs run a local sales tax even though the state does not. Montana does the same on a much smaller scale: certain resort and tourism districts can collect a local sales tax, though most of the state has none. In Delaware, New Hampshire, and Oregon, you typically don't charge sales tax on a standard invoice to a customer in that state.</p>
...
HTML,
    ...
    [
      ...
      'anchor' => 'canada',
      'html' => <<<'HTML'
<p>Canada layers a federal Goods and Services Tax on top of provincial rules, so the rate on a Canadian invoice depends on where the customer is located, not where the seller is. The federal GST is 5 percent. Some provinces harmonize federal and provincial tax into a single Harmonized Sales Tax (HST). Other provinces charge a separate Provincial Sales Tax (PST) alongside the 5 percent GST. Quebec runs its own Quebec Sales Tax (QST).</p>
<p>As of writing, the standard rates by province are:</p>
<ul>
<li><strong>Alberta, Northwest Territories, Nunavut, Yukon.</strong> 5 percent GST only.</li>
<li><strong>Ontario.</strong> 13 percent HST.</li>
<li><strong>New Brunswick, Newfoundland and Labrador, Prince Edward Island.</strong> 15 percent HST.</li>
<li><strong>Nova Scotia.</strong> 14 percent HST (lowered from 15 percent on 1 April 2025).</li>
<li><strong>British Columbia.</strong> 5 percent GST plus 7 percent PST.</li>
<li><strong>Saskatchewan.</strong> 5 percent GST plus 6 percent PST.</li>
<li><strong>Manitoba.</strong> 5 percent GST plus 7 percent PST.</li>
<li><strong>Quebec.</strong> 5 percent GST plus 9.975 percent QST.</li>
</ul>
...
HTML,
    ...
    [
      ...
      'html' => <<<'HTML'
<p>The UK uses Value Added Tax (VAT) as its single consumption tax. As of writing, the standard rate is 20 percent and covers most goods and services. A reduced rate of 5 percent applies to a narrow list of categories, including domestic fuel and power, energy-saving materials in some cases, and child car seats. A zero rate of 0 percent applies to most food, books, newspapers, and children's clothes, which is different from being exempt because zero-rated sales still count toward your taxable turnover.</p>
...
<p>The rate itself is set by the GST Council. Following the GST 2.0 reform that took effect on 22 September 2025, the structure was simplified from four main slabs to three:</p>
<ul>
<li><strong>5 percent.</strong> Essentials, basic food, some agricultural items, and common services like restaurants without input tax credit.</li>
<li><strong>18 percent.</strong> The standard rate for most professional services, software, and most goods. This is the one that applies to a typical consulting, software, or design invoice.</li>
<li><strong>40 percent.</strong> Luxury and sin goods, including tobacco, certain large vehicles, and soft drinks. This slab replaced the old 28 percent band.</li>
</ul>
<p>The previous 12 percent and 28 percent slabs were abolished in the reform. Items that used to sit at 12 percent moved to either 5 or 18 percent, and items that used to sit at 28 percent moved to either 18 or 40 percent. If you remember the old four-slab structure, the practical effect is that most everyday goods and services are now either at 5 or at 18, with a much smaller list at 40.</p>
<p>For a consulting invoice taxed at 18 percent within the same state, you charge 9 percent CGST plus 9 percent SGST. For the same invoice to a client in another state, you charge 18 percent IGST in a single line. The total is the same, but the breakdown is different, and the tax flows to a different place behind the scenes.</p>
<p>Registration becomes mandatory once your aggregate annual turnover from services crosses 20 lakh rupees, or 10 lakh in special category states like the North-Eastern states. Every GST invoice must show your 15-character GSTIN, and Harmonized System of Nomenclature (HSN) codes or Services Accounting Code (SAC) codes have to appear on each line. The HSN requirement scales with turnover: businesses above 5 crore rupees in turnover use 6-digit HSN, while smaller businesses can use 4-digit codes or none at all depending on the current notification. E-invoicing through the Invoice Registration Portal is mandatory once your turnover crosses the relevant threshold (currently 5 crore rupees of aggregate annual turnover, in effect since August 2023, though the threshold has been progressively lowered over the years). The country page for <a href="/free-invoice-generator/india/">Indian invoices</a> covers GSTIN placement and the SAC field. Talk to a CA before you assume a slab for your services.</p>
HTML,
    ],
...
<li><strong>Canada.</strong> The tax row labels itself "GST/HST" so the right acronym appears. You enter the combined rate for the customer's province (5 percent for Alberta, 13 percent for Ontario, 15 percent for the Atlantic HST provinces, and so on).</li>
...
<li><strong>Australia.</strong> The tax row is labelled "GST" and you enter 10 percent. The form also leaves room for your ABN in the business details so it shows on every invoice.</li>
...
<p>Two more controls matter, and they sit right next to the tax field. The exclusive versus inclusive toggle decides whether the tax is added on top of your line totals or pulled out of them. Exclusive is the default, and it's what most B2B invoices in the US, Canada, UK, and India use: a line of 1,000 dollars at 10 percent tax becomes a 1,000 dollar subtotal plus 100 dollars tax for a 1,100 dollar total. Inclusive flips the math: the 1,000 dollar line already includes the tax, so the subtotal works out to about 909 dollars plus about 91 dollars tax for a 1,000 dollar total. Inclusive is common for retail receipts in Australia and the UK where the displayed price already includes tax.</p>
...
HTML,
    ...
    [
      ...
      'html' => <<<'HTML'
<p>The five countries above are the ones the generator handles with a one-click selection, but the manual tax row works for any country in the world. Pick the currency that fits your customer, type the rate into the tax field, choose exclusive or inclusive, and the invoice math runs exactly the same way. That covers billing a client in Germany at 19 percent VAT, in Singapore at 9 percent GST, in the UAE at 5 percent VAT, in South Africa at 15 percent VAT, in New Zealand at 15 percent GST, or anywhere else you happen to be invoicing.</p>
<p>A few quick orientation points for common other markets, as of writing:</p>
<ul>
<li><strong>European Union.</strong> Each member state runs its own VAT. Standard rates range from 17 percent in Luxembourg to 27 percent in Hungary, with most countries sitting between 19 and 25. Cross-border B2B services within the EU often use the reverse charge mechanism, where the customer accounts for the VAT on their own return and you invoice without VAT but with a reverse-charge note.</li>
<li><strong>Singapore.</strong> GST is 9 percent as of 2024.</li>
<li><strong>New Zealand.</strong> GST is a flat 15 percent and the registration threshold is 60,000 New Zealand dollars.</li>
<li><strong>United Arab Emirates.</strong> VAT is 5 percent.</li>
<li><strong>South Africa.</strong> VAT is 15 percent. The compulsory registration threshold rose to 2.3 million rand in any 12-month period as of 1 April 2026 (up from 1 million), with voluntary registration available from 120,000 rand.</li>
</ul>
...
HTML,
  ...
  'faqs' => [
    ...
    [
      ...
      'a' => 'Exclusive means the tax is added on top of your line totals. A line of 1,000 at 10 percent tax becomes a 1,000 subtotal plus 100 tax for a 1,100 total. Inclusive means the tax is already baked into the line price, so the same 1,000 line at 10 percent inclusive becomes about 909 subtotal plus about 91 tax for a 1,000 total. Most B2B invoices in the US, Canada, UK, and India use exclusive pricing so the customer sees the tax listed as its own line. Retail receipts in Australia and the UK often use inclusive pricing because shoppers are used to seeing the final price on the shelf.',
    ],
  ],
