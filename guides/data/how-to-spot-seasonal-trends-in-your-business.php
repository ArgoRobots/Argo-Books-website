<?php
// guides/data/how-to-spot-seasonal-trends-in-your-business.php
...
HTML,
  ...
  'sections' => [
    ...
    [
      ...
      'html' => <<<'HTML'
<p>Seasonality is just a pattern that repeats at roughly the same time every year. It's not random ups and downs, and it is not a one-off good or bad month. It's the same shape coming back around, year after year, driven by something predictable: the weather, the calendar, holidays, school terms, tax deadlines, or simply the habits of your customers.</p>
...
<p><strong>Build a cash buffer in the peak months.</strong> This is the single most important habit for a seasonal business. When the busy months land and money is flowing, the temptation is to treat all of it as yours to spend. It's not. Part of every good month belongs to the slow months ahead. Decide on a percentage of peak-season income to hold back, move it to a separate account so you are not tempted, and let it carry you through the trough. The businesses that struggle are almost always the ones that spent the summer like it would last all year.</p>
